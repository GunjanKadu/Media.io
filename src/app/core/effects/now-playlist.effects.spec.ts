...
//       fetchAllPlaylistItems: jasmine
//         .createSpy('fetchAllPlaylistItems')
//         .and.returnValue(Observable.of([])),
//       fetchMetadata: jasmine
//         .createSpy('fetchMetadata')
//         .and.returnValue(Observable.of([]))
//     };
...
//     it('should fetch playlist items', inject([UserProfile], userProfileSpy => {
